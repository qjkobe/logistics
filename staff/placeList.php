            ...
            <div class="row">
                <div class="col-md-12">
                    <h1 class="page-header">
                        地点列表 <small>欢迎你<?php echo $_SESSION['staffname']; ?></small>
                    </h1>
                </div>
            </div>
            <!-- /. ROW  -->
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="panel panel-default">
                        ...
                        <button class="btn btn-primary add-distance" disabled data-toggle="modal" data-target="#myModal" style="margin:10px 0 0 10px">
                            添加距离
                        </button>
                ...
                <div class="col-md-6">
                    ...
                    <div class="panel panel-default">
                        ...
                        <button class="btn btn-primary add_position" disabled data-toggle="modal" data-target="#PlaceModal" style="margin:10px 0 0 10px">
                            添加地点
                        </button>
                        <div class="panel-body">
                            <div class="table-responsive">
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                for(var i = 0; i < temp.place.length; i++){
                    ...
                    strhtml = strhtml + "<td>" + "<button disabled class='btn btn-primary' onclick='editPosition($(this));' data-toggle='modal' data-target='#PlaceModal'>"
        ...
        $.ajax({
            ...
            success: function(data){
                ...
                for(var i = 0; i < temp.place.length; i++){
                    ...
                    strhtml = strhtml + "<td>" + "<button disabled class='btn btn-primary' onclick='editDistance($(this));' data-toggle='modal' data-target='#myModal'>"
                        + "<i class='fa fa-edit'></i>编辑" + "</button>" + "</td>";
                    strhtml = strhtml + "</tr>";
                }
